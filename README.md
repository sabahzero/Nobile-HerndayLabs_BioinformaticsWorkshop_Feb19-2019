...
Background: What are Jupyter and Git, and why use them? What do they have to do with <i>C. abicans</i>, for example? </br> </br>
  ...
  1. Confirm access to command line for your computer </br>
  If you're not sure how to use or access this, check out this quick introduction from [David Baumgold](https://www.davidbaumgold.com/tutorials/command-line/) 
